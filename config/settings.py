...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'store.views.categories', # make categories available to all html templates
                'cart.context_processors.cart_length', # make cart in session available to all html templates
            ],
        },
    },
]
